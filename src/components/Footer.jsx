...
import { FaFacebook, FaInstagram, FaTelegram, FaWhatsapp, FaPhone, FaEnvelope, FaMapMarkerAlt } from 'react-icons/fa';
    ...
    <FooterWrapper>
      <FooterContent>
        ...
        <SocialLinks>
          ...
          <SocialLink href="https://wa.me/79001234567" target="_blank" rel="noopener noreferrer">
            <FaWhatsapp />
          </SocialLink>
        </SocialLinks>
      </FooterContent>
