...
import { FaInstagram, FaWhatsapp, FaTelegram, FaVk, FaPhone, FaEnvelope, FaMapMarkerAlt } from 'react-icons/fa';
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Свяжитесь с нами для записи на услуги автомойки и детейлинга. Мы всегда на связи!" />
      </Helmet>
      <PageWrapper>
        <Section>
          <Header>
            ...
            <ContactInfo>
              <ContactCard>
                ...
                <ContactItem>
                  <FaEnvelope />
                  <div>
                    <a href="mailto:info@autoclean.ru">info@test.by</a>
                  </div>
                </ContactItem>
                <ContactItem>
                  <FaMapMarkerAlt />
                  <div>
                    г. Гомель, ул. Пушкина, д. 1
                  </div>
                </ContactItem>
                <SocialLinks>
                  ...
                  <SocialLink href="https://wa.me/375291234567" target="_blank" aria-label="WhatsApp">
                    <FaWhatsapp />
                  </SocialLink>
                  <SocialLink href="https://t.me/tg" target="_blank" aria-label="Telegram">
                    <FaTelegram />
                  </SocialLink>
                  <SocialLink href="https://vk.com" target="_blank" aria-label="VKontakte">
                    <FaVk />
                  </SocialLink>
                </SocialLinks>
              </ContactCard>
